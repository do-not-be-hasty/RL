...
class ReplayBuffer(object):
    def __init__(self, size, hindsight=4, hindsight_curriculum=False, sampling_mean_init=2., sampling_mean_growth=0.0003, sampling_mean_max=100, sampling_cut=-1):
        """
    ...
    def add(self, episode):
        ...
        print('buffer size', self._next_idx)
    ...
    def _encode_sample(self, idxes, has_replaced_goal, batch_size):
        ...
        for it in range(len(idxes)):
            ...
            # print(obs_t['observation'].shape, action, reward, obs_tp1['observation'].shape, done, ep_range)
